...
The path of each sequence (\textcolor[HTML]{1f77b4}{bat},
 \textcolor[HTML]{ff7f0e}{rat},
 \textcolor[HTML]{2ca02c}{cat},
 \textcolor[HTML]{d62728}{gnat},
 \textcolor[HTML]{9467bd}{goat})
 from Begin to end is summarized below,

![HMM.pdf](./HMM.pdf)

Nodes that are not visited in any path have uniform probability of transitting
 to its next states:
...
And the transition probabilities of nodes that are visited are listed in the
 following table
...
We can see a clear separation between points that are classified as ATPases and
 those classified as GTPases. The log ratio of ATPase vs GTPase is always way
 larger than 0 or way smaller than 0, indicating high likelihood.
