...
library(doParallel)
```
Problem 17 and 18 are handwritten (not energetic enough for formatting this time as I usually do) and are included using `pdfpages`. Thye don't fit under the title page so I put problem 19 at the beginning.
